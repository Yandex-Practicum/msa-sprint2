...
from app.files.booking.models import Booking
from app.files.booking.schemas import BookingBaseSchema, BookingSchema
...
class BookingRepository:
    ...
    async def create_booking(self, data: BookingBaseSchema) -> BookingSchema:
        async with self.async_session() as session:
            statement = (
                insert(Booking)
