...
class BookingServices:
    def __init__(
        ...
        self.event_manager.subscribe("create_booking", callback=None)
    ...
    async def create_booking(
        ...
        try:
            ...
            discount = self._resolve_promo_discount(
            ...
            self.event_manager.publish(
                event_type="booking_created", message=create_booking_dto.model_dump()
            )
