...
DB_PORT=5432
DB_PORT_BOOKING=9999
DB_NAME=hotelio
DB_NAME_BOOKING=booking
DB_USER=hotelio
DB_PASSWORD=hotelio
...
PGPASSWORD="${DB_PASSWORD}" psql -h "${DB_HOST_BOOKING}" -p "${DB_PORT_BOOKING}" -U "${DB_USER}" "${DB_NAME_BOOKING}" < init-fixtures-booking.sql
...
# пришлось закомментировать из-за https://app.pachca.com/chats/30602228?message=675275543
